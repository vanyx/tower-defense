...
public class ArrowTower extends Tower {
	...
	public ArrowTower(Position p, double squareWidth, double squareHeight) {
		...
		if (reload >= speed) {
			for (Monster i : monsters) {
				...
				if (norme <= reach) {
					...
					Projectile shot = new Arrow(tower, nextMove, i, damage);

					// calcul de l'angle de rotation pour l'affichage de l'image du projectile
	...
	@Override
	public void draw() {
		StdDraw.picture(p.x, p.y, "images/arrowTower" + level + ".png", squareWidth, squareHeight);
